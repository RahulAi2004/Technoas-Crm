// Additive seed: populates demo data WITHOUT wiping the database.
// Unlike seed.js (which calls resetDb()), this preserves existing settings
// (e.g. the live ManyChat connection) and any real conversations.
// insert() upserts by id, so this script is safe to run multiple times.
...
// ---- Conversations (demo; does NOT touch existing mc:* conversations) ----
const CONVS = [
...
const MSGS = [
  { id:'seed-jc-1', conversation_id:'jc', dir:'in',  text:'Hi, we need 50 hoodies for our school event. Can you send me a quote?', time:'10:24 AM' },
  { id:'seed-jc-2', conversation_id:'jc', dir:'out', text:"Hello John! Sure, I'd be happy to help. Could you please share the design and sizes needed?", time:'10:26 AM' },
  { id:'seed-jc-3', conversation_id:'jc', dir:'in',  text:'Here is the design. We need sizes S–2XL.', time:'10:28 AM' },
  { id:'seed-jc-4', conversation_id:'jc', dir:'out', text:"Thanks! I'll prepare the quote and send it shortly.", time:'10:30 AM' },
  { id:'seed-jc-5', conversation_id:'jc', dir:'sys', text:'Conversation assigned to Mike Johnson', time:'10:35 AM' },
  { id:'seed-tm-1', conversation_id:'tm', dir:'in',  text:'Can you share the price list for t-shirts?', time:'10:15 AM' },
  { id:'seed-tm-2', conversation_id:'tm', dir:'out', text:'Sure! What quantity are you looking at?', time:'10:17 AM' },
  { id:'seed-sl-1', conversation_id:'sl', dir:'in',  text:'We need a design for our company anniversary.', time:'09:47 AM' },
  { id:'seed-sl-2', conversation_id:'sl', dir:'in',  text:'Around 200 polo shirts, embroidered logo.', time:'09:48 AM' },
]
...
const NOTES = [
  ...
  { id:'seed-note-2', customer_id:'springfield-hs', title:'Prefers Zelle payment',           category:'Payment',   body:'Always prefers payment via Zelle. Send payment request to timary.zoiae@springfieldhs.edu', author:'Sarah Williams', pinned:1, date:'Apr 25, 2024 · 02:15 PM' },
  ...
  { id:'seed-note-4', customer_id:'springfield-hs', title:'Homecoming 2024 details',         category:'General',   body:'Homecoming on Oct 4, 2024. Expect orders for hoodies, tees and crewnecks.', author:'Timary Zoiaor',  pinned:0, date:'Apr 15, 2024 · 09:30 AM' },
  { id:'seed-note-5', customer_id:'springfield-hs', title:'Late approval caused delay',      category:'Complaint', body:'Artwork approval was delayed from customer side. Need earlier follow up next time.', author:'Sarah Williams', pinned:0, date:'Mar 30, 2024 · 04:22 PM' },
]
...
console.log('\n✅ Demo data added (existing settings & conversations preserved).')
